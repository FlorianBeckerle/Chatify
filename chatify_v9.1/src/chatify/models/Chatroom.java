...
public class Chatroom {
    ...
    public String countChatrooms(Statement statement) {
        try {
            ...
            Logger.getLogger(Chatroom.class.getName()).log(Level.SEVERE, null, ex);
            return("fehler: countChatrooms");
        }
    }
    
    public String countChatroomsUser(Statement statement, String userid) {
        try {
            String sql = "select count(chatroom_chatroomid) from chatparticipants where user_userid="+userid+"";
            ResultSet rs = statement.executeQuery(sql);
            ...
            Logger.getLogger(Chatroom.class.getName()).log(Level.SEVERE, null, ex);
            return "fehler: countChatroomsUser";
        }
    }
