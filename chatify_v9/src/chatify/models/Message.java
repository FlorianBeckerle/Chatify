...
public class Message {
    ...
    public Message(String messageContent, String userid, String chatroomId, String username) {
        setMessageContent(messageContent);
        setUserId(userid);
        setChatroomId(chatroomId);
    ...
    public Message(Statement statement, String messageContent, String userid, String chatroomid, String username) {
    ...
    public ObservableList<Message> getMessages(Statement statement, String chatroomId) {
        try {
            String sql = "select * from message, benutzer where message.user_userid = benutzer.userid and chatroom_chatroomid ="+ chatroomId; //Einschränkung fehlt nocht
            ResultSet rs = statement.executeQuery(sql);
            ObservableList<Message> messages = FXCollections.observableArrayList();
            while (rs.next()) {
                messages.add(new Message(rs.getString("messagecontent"), rs.getString("user_userid"), rs.getString("chatroom_chatroomid"), rs.getString("username")));
